    ...
    render() {
        return (
            <div>
                ...
                <div id="bot" style={{ border: '2px solid gray', background: 'white', borderRadius: '25px', width: '200px', padding: '10px', textAlign: 'center', margin: '100px auto', fontSize: '20px', color: 'rgba(150, 150, 150, 0.8)' }}>
